var EventGroups = {
  groupEventsIntoOverlapSlots: function (events) {
    ...
    function prepareNewSlotWithEv(slotsForEvent, ev) {
      return {
    ...
    var slots = events.reduce(function (overlapSlots, ev) {
      ...
      var newSlot = prepareNewSlotWithEv(slotsForEvent, ev);
